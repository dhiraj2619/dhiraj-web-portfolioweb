...
const Projects = ({
  ...
  return (
    <section ref={sectionRef} className="relative h-screen px-4 md:px-8 py-16">
        ...
        <div className="relative mx-auto h-[68vh] max-w-3xl">
          {skills.map((skill, index) => (
            <article
              ...
              className={`absolute inset-0 rounded-3xl border border-zinc-700/70 bg-gradient-to-br ${skill.tone} p-6 md:p-10 shadow-[0_15px_40px_rgba(0,0,0,0.65)]`}
            >
